...
class Region {
  constructor(params, regionsUtils, ws) {
    ...
    let channelCount = ws.regions.params.channelCount && ws.params.splitChannels ? ws.regions.params.channelCount : -1;
...
/* harmony export */ });
/* harmony import */ var _region_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./region.js */ "./src/plugin/regions/region.js");
/**
...
class RegionsPlugin {
  ...
  constructor(params, ws) {
    ...
    this.wavesurfer.Region = _region_js__WEBPACK_IMPORTED_MODULE_0__.Region; // By default, scroll the container if the user drags a region
