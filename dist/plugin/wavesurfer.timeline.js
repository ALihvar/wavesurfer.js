...
/* harmony export */   "default": () => (/* binding */ TimelinePlugin)
/* harmony export */ });
/**
...
class TimelinePlugin {
  ...
  renderCanvases() {
    ...
    const positioning = []; // render until end in case we have a negative offset

    const renderSeconds = this.params.offset < 0 ? totalSeconds - this.params.offset : totalSeconds;
